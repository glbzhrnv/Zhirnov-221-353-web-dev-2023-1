...
function evaluate(rpn) {
  ...
  // Функция clickHandler принимает событие клика 
  // и обрабатывает нажатие на кнопку калькулятора.
  // ----------------------------------------------------------------------------
  // The clickHandler function takes a click event 
  // and handles button clicks in the calculator.
  ...
  // Функция window.onload устанавливает обработчики 
  // событий после полной загрузки страницы.
  // ----------------------------------------------------------------------------
  // The window.onload function sets event handlers 
